...
class CardControllerTest {
    ...
    void testGetAll() {
        ...
        cards.add(new Card("Card 1", "Description 1", null, null, null));
        cards.add(new Card("Card 2", "Description 2", null, null, null));
    ...
    void testGetByIdWithValidId() {
        long id = 1L;
        Card card = new Card("Card 1", "Description 1", null, null, null);
    ...
    void testAddWithInvalidTitle() {
        Card card = new Card(null, "Description 1", null, null, null);
    ...
    void testUpdateWithValidIdAndCard() {
        long id = 1L;
        Card existingCard = new Card("Card 1", "Description 1", null, null, null);
        Card updatedCard = new Card("Card 1 Updated", "Description 1 Updated", new ArrayList<>(), new HashSet<>(), null);
